...
function fixContainerOnIE10(element) {
...
var actions = {
    confirm: function (event) { return function (ref) {
    ...
    cancel: function (reason) { return function (ref) {
        var parent = ref.parent;
        var element = ref.element;
        var resolve = ref.resolve;
...
var Body = function ( ref ) {
    var text = ref.text; if ( text === void 0 ) text = '';
    var rest = {}; for (var n in ref) if(["text"].indexOf(n) === -1) rest[n] = ref[n];
    var props = rest;
    ...
    return (
        h( 'div', { class: "msg", oncreate: function (element) {element.innerHTML = '<div>' + text + '</div>'; } }
        )
    )
};

var Footer = function (ref) {
    if ( ref === void 0 ) ref = {};
    var confirm = ref.confirm; if ( confirm === void 0 ) confirm = {};
    ...
    return (
        h( 'div', { class: "footer" }, 
            h( ConfirmButton, Object.assign({}, { text: confirm.text, confirm: actions.confirm }, confirm))
        )
    )
};

var ConfirmButton = function (ref) {
    if ( ref === void 0 ) ref = {};
    var text = ref.text; if ( text === void 0 ) text = '';
    var confirm = ref.confirm;
    var rest = {}; for (var n in ref) if(["text", "confirm"].indexOf(n) === -1) rest[n] = ref[n];
    var props = rest;
    ...
    return (
        h( 'button', { 
            onclick: function () { return confirm(); }, class: "ok" }, 
            text
        )
    )
};

var view = function (state, actions) { return (
    h( 'div', { 
        class: 'dialog', onclick: function (event) { return event.stopPropagation(); } }, 
        h( 'div', null, 
            h( Header, state.header), 
            h( Body, state.body), 
            h( Footer, Object.assign({}, { actions: actions }, state.footer))
        )
    )
); };
...
var index = function (ref) {
    if ( ref === void 0 ) ref = {};
    var header = ref.header; if ( header === void 0 ) header = {};
    var body = ref.body; if ( body === void 0 ) body = {};
    var footer = ref.footer; if ( footer === void 0 ) footer = {};
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiYWxlcnQuanMiLCJzb3VyY2VzIjpbXSwic291cmNlc0NvbnRlbnQiOltdLCJuYW1lcyI6W10sIm1hcHBpbmdzIjoiIn0=
